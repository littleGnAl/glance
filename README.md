...
> Currently, only Android is supported. iOS is still a work in progress. APIs may change without notice before it reaches stable version 1.0.

An APM (Application Performance Monitoring) library for detecting UI jank in Flutter for mobile.
